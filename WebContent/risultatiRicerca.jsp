...
<%-- 			<img alt="" src="${u.avatar}"> --%>
			...
			<a href="profilo.jsp" id="${u.nickname}"><img src="${u.avatar}"  width="64px" height="64px" style="border-radius:50%;"> ${u.nickname},${u.nome},${u.cognome}</a>
			</c:if>
			
			<c:if test="${ (empty user.nickname) || (user.nickname ne u.nickname) }">
			<a href="profiloUtente.jsp" id="${u.nickname}"><img src="${u.avatar}" width="64px" height="64px" style="border-radius:50%; border:2px solid white;"> ${u.nickname},${u.nome},${u.cognome}</a>
			</c:if>
