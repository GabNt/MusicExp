				...
				<div class="col-sm-9 ">
					<div class="boxinfo">
						...
						<div class="boxinfo--info">
							<div style="min-height: 115px">Nome: "${user.nome}"</div>
							<div style="min-height: 115px">Cognome: "${user.cognome}"</div>
							<div style="min-height: 115px">Data di nascita:
								"${user.data_nascita}"</div>
							<div style="min-height: 115px">Citta' residenza:
								"${user.citta_residenza}"</div>
						</div>
						<div class="boxinfo--impostazioni">
							<form method="post" action="AggiornaMail">
							...
							<form method="post" action="AggiornaPass">
							...
							<form method="post" action="AggiornaResidenza">
							...
							<form method="post" action="AggiornaBio">
								<div class="cambiabio">
									<div class="control-group">
