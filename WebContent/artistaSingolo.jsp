...
<!-- 		<p>IMMAGINE COPERTINA</p> -->
		...
		<a id="sitoWeb" style="float:left; color:#660000; font-weight:bold;"></a>
		</div>
		
		<br><p style="font-weight:bold; color:#000000; margin-top:10px; background-color:transparent;">Bio:</p></br>
	...
	<div class="boxinfoexperience" style=" border-radius:10px; background:#e6e6e6; border:1px solid #660000"">
		...
		<ul id="myUL" class="experiences" style="padding:10px;">
			<!-- riempita da ajax -->
