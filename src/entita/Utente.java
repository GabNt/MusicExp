...
//	private Set<MessaggioPubblico> messaggi_pubblici_inviati;
...
//	public Set<MessaggioPubblico> getMessaggi_pubblici_inviati() {
//		return messaggi_pubblici_inviati;
//	}
//
//	public void setMessaggi_pubblici_inviati(Set<MessaggioPubblico> messaggi_pubblic_inviati) {
//		this.messaggi_pubblici_inviati = messaggi_pubblic_inviati;
//	}

	public Utente() 
	{
		acquisti = new HashSet<Prodotto>();
		prodotti_realizzati = new HashSet<Prodotto>();
		experiences_create = new HashSet<Experience>();
	}
	...
	public Utente(String nickname, String nome, String cognome, Date data_nascita, String citta_residenza, String mail, String pass,boolean admin) {
		this();
	...
	public void aggiungiAcquisto(Prodotto pr) {
		...
		if (this.getAcquisti() == null) {
			this.acquisti = new HashSet<Prodotto>();
		}

		this.getAcquisti().add(pr);
	}

	public void rimuoviAcquisto(Prodotto pr) {
		this.getAcquisti().remove(pr);
	}

	public void aggiungiProdottoRealizzato(Prodotto pr) {
		if (this.getProdotti_realizzati() == null) {
			this.prodotti_realizzati = new HashSet<Prodotto>();
		}
...
//	}
	...
	public void setMod(boolean admin) {
		this.moderatore = admin;
	}
	...
	public String toString() 
	{
		...
		return "Utente[" + this.getNickname() + ", " + this.getNome() + ", " + this.getCognome() + ", "
				+ sdf.format(this.getData_nascita()) + ", " + this.getMail() + this.getPassword() + this.isMod()
				+ this.getBio() + "]";
	}
