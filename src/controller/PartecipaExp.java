...
//
						...
						//	Facade.sendMessage(mailOrg,"AGGIUNTA NUOVO MEMBRO ALLA TUA EXPERIENCE "+e.getID(), "C''e un nuovo utente che partecipa alla tua experience! Il suo nickaname e' "+nickLoggato);
						...
						//INVIO MAIL ALTRI PARTECIPANTI
										...
										for(int i=0;i<nicknamePartecipanti.size();i++)
										{
											...
											{
//												Facade.sendMessage(send, object, messageArea);
