...
//				Facade.sendMessage(mailOrg,"L'UTENTE "+daRimuovere+" HA ANNULLATO LA PARTECIPAZIONE DALLA TUA EXPERIENCE "+e.getID(), "Un utente non partecipa piu alla tua experience! Il suo nickaname e' "+daRimuovere);
