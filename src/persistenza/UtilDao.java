	...
	public void createDatabase(){
		...
		try {
			...
			String delete = "create SEQUENCE sequenza_ID;"
					...
					+ "create table utente (\"nickname\" varchar(255) primary key, nome varchar(255), cognome varchar(255), data_nascita Date,citta_residenza varchar(255), mail varchar(255), password varchar(255), avatar varchar(255), bio text, admin boolean);"
					+ "create table artista (\"nome\" varchar(255) primary key, on_tour boolean, sito_web varchar(255),immagine varchar(255),genere varchar(255),copertina varchar(255));"
					+ "create table experience(\"id\" int primary key, limite_adesione Date,posti int, organizzatore varchar(255) REFERENCES utente(\"nickname\"), evento int REFERENCES evento(\"id\"), descrizione text);" 
					+ "create table prodotto (\"id\" int primary key, nome varchar(255), prezzo int, colore varchar(255), tipo varchar(255),descrizione text,quantita int, realizzatore varchar(255) REFERENCES utente(\"nickname\"),immagine varchar(70));"
					...
					+ "create table acquisto(\"id\" int primary key, utente varchar(255) REFERENCES utente(\"nickname\"),prodotto int REFERENCES prodotto(\"id\"));"
