...
public class ProdottoDaoJDBC implements ProdottoDao{
	...
	public void save(Prodotto pr) {
		...
		try {
			...
			pr.setID(id); 			
			String insert = "insert into prodotto(id,nome,prezzo,colore,tipo,descrizione,quantita,immagine) values (?,?,?,?,?,?,?,?)";
	...
	public void update(Prodotto pr) {
		Connection connection = this.ds.getConnection();
		try {
			String update = "update prodotto SET nome=?, prezzo=?, colore=?, tipo=?, descrizione=?, quantita=?, immagine=? WHERE id=?";
